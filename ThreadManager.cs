...
namespace CADIS.Solution.Workflow
{
    ...
    internal class ThreadManager
    {
        ...
        ConcurrentQueue<KeyValuePair<Int64,
        String>> mLog;
        ...
        {
            mLog = new ConcurrentQueue<KeyValuePair<Int64,
            String>>();
        ...
        public ConcurrentQueue<KeyValuePair<Int64,
        String>> LogMessages
        {
            get
            {
    ...
    public class InvalidReleaseException : Exception
        {
            public override string Message
            {
                get
                {
                    return "Cannot release more threads than have been allocated";
                }
            }
        }
    }
